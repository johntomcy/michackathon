...
exports.default = Task.extend({
    run: function (runTaskOptions) {
        ...
        var config = new webpack_config_1.NgCliWebpackConfig(project, runTaskOptions.target, runTaskOptions.environment, runTaskOptions.outputPath, runTaskOptions.baseHref, runTaskOptions.aot).config;
